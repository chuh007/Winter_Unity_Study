...
namespace Code.Players.States
{
    public class PlayerCounterAttackState : EntityState
    {
        ...
        {
            ICounterable counterable = _attackCompo.GetCounterableTargetInRadius();

            if(counterable is { CanCounter: true})
            {
                ...
                counterable.ApplyCounter(damage, attackDirection, knockBackForce, attackData.isPowerAttack, _player);
